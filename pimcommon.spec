...
Version  : 22.08.1
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.08.1/src/pimcommon-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/pimcommon-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/pimcommon-22.08.1.tar.xz.sig
...
%prep
%setup -q -n pimcommon-22.08.1
cd %{_builddir}/pimcommon-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662783968
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5PimCommon.so.5.21.1
/usr/lib64/libKF5PimCommonAkonadi.so.5
/usr/lib64/libKF5PimCommonAkonadi.so.5.21.1
