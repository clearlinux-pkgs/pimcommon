...
Version  : 22.08.0
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.0/src/pimcommon-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/pimcommon-22.08.0.tar.xz
...
%prep
%setup -q -n pimcommon-22.08.0
cd %{_builddir}/pimcommon-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661554967
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5PimCommon.so.5.21.0
/usr/lib64/libKF5PimCommonAkonadi.so.5
/usr/lib64/libKF5PimCommonAkonadi.so.5.21.0
