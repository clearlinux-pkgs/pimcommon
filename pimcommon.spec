...
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/pimcommon-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/pimcommon-22.12.2.tar.xz.sig
...
%prep
%setup -q -n pimcommon-22.12.2
cd %{_builddir}/pimcommon-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676867288
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pimcommon-%{version}/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/pimcommon/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9 || :
...
/usr/lib64/libKF5PimCommon.so.5.22.2
/usr/lib64/libKF5PimCommonAkonadi.so.5
/usr/lib64/libKF5PimCommonAkonadi.so.5.22.2
/usr/lib64/libKF5PimCommonAutoCorrection.so.5
/usr/lib64/libKF5PimCommonAutoCorrection.so.5.22.2
...
/usr/share/package-licenses/pimcommon/c011fda7746c087a127999da1c4044854ee42238
