...
Version  : 20.08.2
Release  : 27
URL      : https://download.kde.org/stable/release-service/20.08.2/src/pimcommon-20.08.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/pimcommon-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/pimcommon-20.08.2.tar.xz.sig
...
%prep
%setup -q -n pimcommon-20.08.2
cd %{_builddir}/pimcommon-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602708742
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/pimcommon-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/pimcommon/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/pimcommon-20.08.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/pimcommon/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5PimCommon.so.5.15.2
/usr/lib64/libKF5PimCommonAkonadi.so.5
/usr/lib64/libKF5PimCommonAkonadi.so.5.15.2
