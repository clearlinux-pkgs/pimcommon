...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712893088
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6PimCommon.so.6.0.2
/V3/usr/lib64/libKPim6PimCommonAkonadi.so.6.0.2
...
/usr/lib64/libKPim6PimCommon.so.6.0.2
/usr/lib64/libKPim6PimCommonAkonadi.so.6
/usr/lib64/libKPim6PimCommonAkonadi.so.6.0.2
