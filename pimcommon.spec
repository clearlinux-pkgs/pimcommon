...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/pimcommon-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/pimcommon-24.05.1.tar.xz.sig
...
%setup -q -n pimcommon-24.05.1
cd %{_builddir}/pimcommon-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718566831
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6PimCommon.so.6.1.1
/V3/usr/lib64/libKPim6PimCommonAkonadi.so.6.1.1
...
/usr/lib64/libKPim6PimCommon.so.6.1.1
/usr/lib64/libKPim6PimCommonAkonadi.so.6
/usr/lib64/libKPim6PimCommonAkonadi.so.6.1.1
