...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/pimcommon-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/pimcommon-23.08.4.tar.xz.sig
...
%prep
%setup -q -n pimcommon-23.08.4
cd %{_builddir}/pimcommon-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702991058
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5PimCommon.so.5.24.4
/V3/usr/lib64/libKPim5PimCommonAkonadi.so.5.24.4
...
/usr/lib64/libKPim5PimCommon.so.5.24.4
/usr/lib64/libKPim5PimCommonAkonadi.so.5
/usr/lib64/libKPim5PimCommonAkonadi.so.5.24.4
