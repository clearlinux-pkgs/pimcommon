...
%setup -q -n pimcommon-25.04.1
cd %{_builddir}/pimcommon-25.04.1
pushd ..
cp -a pimcommon-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747177165
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6PimCommon.so.6.4.1
/V3/usr/lib64/libKPim6PimCommonActivities.so.6.4.1
/V3/usr/lib64/libKPim6PimCommonAkonadi.so.6.4.1
...
/usr/lib64/libKPim6PimCommon.so.6.4.1
/usr/lib64/libKPim6PimCommonActivities.so.6
/usr/lib64/libKPim6PimCommonActivities.so.6.4.1
/usr/lib64/libKPim6PimCommonAkonadi.so.6
/usr/lib64/libKPim6PimCommonAkonadi.so.6.4.1
