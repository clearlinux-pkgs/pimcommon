...
Version  : 24.12.2
Release  : 114
URL      : https://download.kde.org/stable/release-service/24.12.2/src/pimcommon-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/pimcommon-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/pimcommon-24.12.2.tar.xz.sig
...
%setup -q -n pimcommon-24.12.2
cd %{_builddir}/pimcommon-24.12.2
pushd ..
cp -a pimcommon-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738986809
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6PimCommon.so.6.3.2
/V3/usr/lib64/libKPim6PimCommonActivities.so.6.3.2
/V3/usr/lib64/libKPim6PimCommonAkonadi.so.6.3.2
...
/usr/lib64/libKPim6PimCommon.so.6.3.2
/usr/lib64/libKPim6PimCommonActivities.so.6
/usr/lib64/libKPim6PimCommonActivities.so.6.3.2
/usr/lib64/libKPim6PimCommonAkonadi.so.6
/usr/lib64/libKPim6PimCommonAkonadi.so.6.3.2
