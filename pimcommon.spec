...
%setup -q -n pimcommon-24.12.0
cd %{_builddir}/pimcommon-24.12.0
pushd ..
cp -a pimcommon-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735265707
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6PimCommon.so.6.3.0
/V3/usr/lib64/libKPim6PimCommonActivities.so.6.3.0
/V3/usr/lib64/libKPim6PimCommonAkonadi.so.6.3.0
...
/usr/lib64/libKPim6PimCommon.so.6.3.0
/usr/lib64/libKPim6PimCommonActivities.so.6
/usr/lib64/libKPim6PimCommonActivities.so.6.3.0
/usr/lib64/libKPim6PimCommonAkonadi.so.6
/usr/lib64/libKPim6PimCommonAkonadi.so.6.3.0
