...
Version  : 22.12.3
Release  : 55
URL      : https://download.kde.org/stable/release-service/22.12.3/src/pimcommon-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/pimcommon-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/pimcommon-22.12.3.tar.xz.sig
...
%prep
%setup -q -n pimcommon-22.12.3
cd %{_builddir}/pimcommon-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677798133
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5PimCommon.so.5.22.3
/usr/lib64/libKF5PimCommonAkonadi.so.5
/usr/lib64/libKF5PimCommonAkonadi.so.5.22.3
/usr/lib64/libKF5PimCommonAutoCorrection.so.5
/usr/lib64/libKF5PimCommonAutoCorrection.so.5.22.3
